...
| `comparison_shares`                                          | Secure public comparison links (token hash, expiry, revoke) — **4C shipped**   |
| `comparison_share_items`                                     | Explicit 2–5 listing selection frozen at create — **4C shipped**               |
| `comparison_share_access_events`                             | Privacy-minimal resolve events — **4C shipped**                                |
