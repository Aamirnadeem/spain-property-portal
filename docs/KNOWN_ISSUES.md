...
23. ~~Phase 4B/4C not started~~ — **Resolved for 4B:** Phase **4B implemented** (ADR-030b). **Resolved for 4C:** Phase **4C implemented** (ADR-030c) — see [`PHASE4C_IMPLEMENTATION.md`](PHASE4C_IMPLEMENTATION.md).
